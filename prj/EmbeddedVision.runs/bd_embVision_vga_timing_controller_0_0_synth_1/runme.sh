...
HD_PWD='C:/Projects/EmbeddedVision/prj/EmbeddedVision.runs/bd_embVision_vga_timing_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_embVision_vga_timing_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_embVision_vga_timing_controller_0_0.tcl
