...
ISEStep( "vivado",
         "-log bd_embVision_vga_timing_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_embVision_vga_timing_controller_0_0.tcl" );
